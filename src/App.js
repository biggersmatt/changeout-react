...
class App extends React.Component {
  ...
  signup = (data) => {
    fetch('http://gentle-savannah-74717.herokuapp.com/users/signup',{
      method: "POST",
      credentials: "include",
      headers: {
  ...
  login = (data) => {
    fetch(`http://gentle-savannah-74717.herokuapp.com/users/login`, {
      method: "POST",
      credentials: "include",
      headers: {
        "Content-Type": "application/json",
  ...
  logout = () => {
    fetch(`http://gentle-savannah-74717.herokuapp.com/users/logout`, {
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json'
        },
        ...
        if(endcapData.length > this.state.endcaps.length) {
          ...
          .then((jsonData) => {
            ...
            // Updates Database with New Order
              fetch(`http://gentle-savannah-74717.herokuapp.com/settings/${currentColNew._id}`, {
                method: 'PUT',
                headers: {
                  'Content-Type': 'application/json',
                },
  ...
  handleToggleFlank = (toggle, flank) => {
    if(!toggle) {
      ...
      fetch(`http://gentle-savannah-74717.herokuapp.com/flanks/${flank._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
